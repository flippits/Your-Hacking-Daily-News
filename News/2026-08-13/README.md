# Your Hacking Daily News — 2026-08-13
...
_Read more:_ https://msrc.microsoft.com/update-guide/vulnerability/CVE-2026-62747
...
_Read more:_ https://msrc.microsoft.com/update-guide/vulnerability/CVE-2026-62913
...
_Read more:_ https://msrc.microsoft.com/update-guide/vulnerability/CVE-2026-68815
...
**Mini‑article:** In the past few weeks, I have been using Gemma4 as a Large Language Model (LLM) to see how useful it can be to analyze some of the malware hashes uploaded to the DShield sensor over the past 30 days and figure out how its recommendation can be considered useful about the activity my DShield sensor is collecting and tracking. The model I use for this...
